...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('msymlimport_core_path', null,
                    $modx->getOption('core_path') . 'components/msymlimport/') . 'model/';
            $modx->addPackage('msymlimport', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/msymlimport/model/schema/msymlimport.mysql.schema.xml';
